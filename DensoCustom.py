...
#
# To edit/test this POST PROCESSOR script file: Select "Program"->"Add/Edit Post Processor", then select your post or
# create a new one. You can edit this file using any text editor or Python editor. Using a Python editor allows to
# quickly evaluate a sample program at the end of this file. Python should be automatically installed with RoboDK
#
...
class RobotPost(object):
    ...
    def __init__(self, robotpost=None, robotname=None, robot_axes=6, **kwargs):
        ...
        self.system_state_holder = SystemStateHolder()
        self.poses = list()
    ...
    def ProgSave(self, folder, progname, ask_user=False, show_result=False):
        ...
        **Tip**:
        ...
        :param folder: Folder hint to save the program :type folder: str :param progname: Program name as a hint to
        save the program :type progname: str :param ask_user: True if the default settings in RoboDK are set to
        prompt the user to select the folder :type ask_user: bool, str :param show_result: False if the default
    ...
    def MoveBase(self, pose, joints, interpolation: MoveInterpolation, *args, **kwargs):
        fig = get_fig(joints)
        self.poses.append(RobotMotion(self.system_state_holder.active_frame, self.system_state_holder.active_tool,
                                      Pose(np.array(list(pose)), fig), joints, interpolation, *args, **kwargs))

    def MoveJ(self, pose, joints=None, conf_RLF=None, *args, **kwargs):
        ...
        **Tip**:
        ...
        """
        self.MoveBase(pose, joints, MoveInterpolation.JOINT, *args, **kwargs)

    def MoveL(self, pose, joints=None, conf_RLF=None, *args, **kwargs):
        ...
        **Tip**:
        ...
        :type conf_RLF: int list
        """
        self.MoveBase(pose, joints, MoveInterpolation.LINEAR, *args, **kwargs)
    ...
    def setDO(self, io_var, io_value):
        """Set a digital output to the specified value. This function can also be used to set other variables.

        **Tip**:
        setDO is triggered by the RoboDK instruction Program->Set or Wait I/O Instruction.

        :param io_var: digital output to set, provided as a str or int
        :type io_var: int, str
    ...
    def setAO(self, io_var, io_value):
        """Set an analog output. This method can also be used to set other variables.

        **Tip**:
        setAO is triggered by the RoboDK instruction Program->Set or Wait I/O Instruction.

        :param io_var: analog output to set, provided as a str or int
        :type io_var: int, str
        :param io_value: value of the variable, provided as a str, float or int
        :type io_value: int, float, str
        """
    ...
    def addlog(self, newline):
        """Add a message to the log. This is a private method used only by the other methods. The log is displayed
        when the program is generated to show any issues when the robot program has been generated.
